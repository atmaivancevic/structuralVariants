...
##
## Example usage:
## INDIR=/data/neurogenetics/alignments/Illumina/genomes/allGenomes sbatch --array 0-126 dellyCall_sourceCodeVersion.sh
...
# compile delly from source 
# to incorporate latest commits
# cd /fast/users/a1211880/GITHUBrepos/
...
DELLYEXE=$FASTDIR/GITHUBrepos/delly/src/delly
